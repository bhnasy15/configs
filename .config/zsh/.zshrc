...
PROMPT=$'%B%F{%(#.blue.green)}[%B%F{reset}%(6~.%-1~/…/%4~.%5~)%B%F{%(#.blue.green)}] %B%(#.%F{red}#.%F{blue}$)%b%F{reset} '
#PROMPT=$'%B%F{%(#.blue.green)}[%B%F{reset}%1~%B%F{%(#.blue.green)}] %B%(#.%F{red}#.%F{blue}$)%b%F{reset} '
